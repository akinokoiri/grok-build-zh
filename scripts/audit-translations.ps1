...
$RequiredIds = @(
    ...
    "source.Messages",
    "source.Reasoning/overhead",
    "source.Free",
    "source.Tool definitions",
    "source.Skills",
    "source.Workflows",
    "source.MCP servers",
    "source.Tip: run /compact to free up context space.",
    "source.Tab switch",
    "source.↑/↓ scroll",
    "source.c copy session ID",
    "source.y copy all",
    "source.Esc close",
    "source.No active session.",
    "source.Loading context usage…",
    ...
    "context.count.workflow",
    "context.count.workflows",
    "context.count.server",
    "context.count.servers",
    "context.count.file",
    "context.count.files",
