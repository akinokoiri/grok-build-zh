...
const VOICE_STT_LANGUAGE_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "pt",
        display: "葡萄牙语",
        description: "葡萄牙语语音识别。",
    },
    EnumChoice {
        canonical: "ro",
        display: "罗马尼亚语",
        description: "罗马尼亚语语音识别。",
    },
    EnumChoice {
        canonical: "ru",
        display: "俄语",
